...
(doom! :input
       ...
       (spell +everywhere +aspell +hunspell +flyspell +enchant) ; tasing you for misspelling mispelling
       ...
       (java +meghanada +lsp +eclim) ; the poster child for carpal tunnel syndrome
       ...
       (python +lsp +conda +pyenv +poetry +cython)           ; beautiful is better than ugly
       qt                ; the 'cutest' gui framework ever
       racket            ; a DSL for DSLs
       raku              ; the artist formerly known as perl6
       rest              ; Emacs as a REST client
       rst               ; ReST in peace
       (ruby +rails +lsp +rvm +rbenv +chruby)     ; 1.step {|i| p "Ruby is #{i.even? ? 'love' : 'life'}"}
